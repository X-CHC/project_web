    ...
    <div class="d-flex flex-column">
      <div class="p-2 " >
        ...
        <div class="p-2 flex-grow-1 ">
          <form role="form" method="post" enctype="multipart/form-data" action="<?= base_url('/admin/post_bayar');?>" id="loginForm">
            <div class="row">
              ...
              <div class="col-md-6">
              <em>tiap anggota simpanan melakukan pembayaran sebesar Rp. 25.000 untuk simpanan wajib</em>
                <label for="bukti" class="form-label" id="atasBukti">Bukti Simpanan Pokok</label>
