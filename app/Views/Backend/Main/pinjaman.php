    ...
    <div class="d-flex flex-column" >
      ...
      <div class="p-2 flex-grow-1 ">        
        <div class="d-flex justify-content-between mb-3">
            <h2 class="" style="color: #808080;">Daftar Anggota Pinjaman</h2>
            <div>
        ...
        <table class="table table-light">
          <thead>
            ...
            <tbody>
              <tr>
                <th scope="row">PA001</th>
                <td>Dian Purnama</td>
                <td>07/12/2023</td>
                <td>dian.purnama@live.com</td>
                <td>Rp.30.000.000</td>
                <td><a href="/admin/anggota/d_anggota_2" class="btn btn-primary">Detail</a></td>
              </tr>
              <tr>
                <th scope="row">PA002</th>
                <td>Eka Putri</td>
                <td>09/12/2023</td>
                <td>eka.putri@icloud.com</td>
                <td>Rp.15.000.000</td>
                <td><a href="#" class="btn btn-primary">Detail</a></td>
              </tr>
              <tr>
                <th scope="row">PA003</th>
                <td>Fajar Nugraha</td>
                <td>11/12/2023</td>
                <td>fajar.nugraha@protonmail.com</td>
                <td>Rp.20.000.000</td>
                <td><a href="#" class="btn btn-primary">Detail</a></td>
              </tr>
            </tbody>
