  ...
  <div class="row">
    <div class="d-flex flex-column" >
      ...
      <div class="p-2 flex-grow-1 ">        
        ...
        <?php if($status=='aktif') {echo '<h2 class="" style="color: #808080;">Daftar Anggota Pinjaman Lunas</h2>';} elseif ($status = "taktif"){echo '<h2 class="" style="color: #808080;">Daftar Anggota Pinjaman Belum Lunas</h2>';}?>
            <div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="#" onclick="doUbahP('<?= sha1($data['id_pinjaman']);?>')"><button type="button" class="btn btn-sm btn-danger">Ubah Status</button></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
